...
void addstudentsubjects(int m,int **subjects)
{
    ...
    else if(m==3)
    {
        ...
        cout << "Enter the number of backlogs the student has-" << endl;
        int p;
        cin >> p;
        for(int i=0;i<p;i++)
        {
...
void addteachersubjects(string u,int **subjects,int p)
{
    ...
    if(x==1)
    {
        cout << "The teacher belongs to mathematics department.\nHe can teach subjects with code-A1,C1,E1,G1" << endl;
    }
    else if(x==2)
    {
        cout << "The teacher belongs to physics department.\nHe can teach subjects with code-A2,C2,E2,G2" << endl;
    }
    else if(x==3)
    {
        cout << "The teacher belongs to electronics department.\nHe can teach subjects with code-A3,C3,E3,G3" << endl;
    }
    else if(x==4)
    {
        cout << "The teacher belongs to computer science department.\nHe can teach subjects with code-A4,C4,E41,E42,E43,E44,E45,E46,G4" << endl;
    }
    else if(x==5)
    {
        cout << "The teacher belongs to humanities and social sciences department.\nHe can teach subjects with code-A5,C5,E51,E52,E53,E54,E55,E56,G51,G52,G53,G54,G55,G56" << endl;
    }
    }
    else
    {
    if(x==1)
    {
        cout << "The teacher belongs to mathematics department.\nHe can teach subjects with code-B1,D1,F1,H1" << endl;
    }
    else if(x==2)
    {
        cout << "The teacher belongs to physics department.\nHe can teach subjects with code-B2,D2,F2,H2" << endl;
    }
    else if(x==3)
    {
        cout << "The teacher belongs to electronics department.\nHe can teach subjects with code-B3,D3,F3,H3" << endl;
    }
    else if(x==4)
    {
        cout << "The teacher belongs to computer science department.\nHe can teach subjects with code-B4,D4,F4,H4" << endl;
    }
    else if(x==5)
    {
        cout << "The teacher belongs to humanities and social sciences department.\nHe can teach subjects with code-B5,D51,D52,D53,D54,D55,D56,F5,H5" << endl;
    }
    }
    vector<string> v;
    cout << "Enter the number of subjects " << u << " teaches" << endl;
    int d;
    cin >> d;
    for(int i=0;i<d;i++)
    {
        ...
        while(renewed[k].colour<=3*(j+1) && k<renewed.size())
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    for(int i=1;i<(renewed[k].colour-limit)%4;i++)
                    {
                        answer[checker[renewed[k].colour]].push_back(fake);
                    }
                }
...
int main()
{
    ...
    while(1)
    {
        ...
        gotoxy(2,11);
        cout << "3.Graph colouring result" << endl;
        gotoxy(2,12);
        cout << "4.Exit" << endl;
        gotoxy(2,14);
        cout<<endl;
